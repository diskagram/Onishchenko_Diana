...
namespace Chrome_Driver_Launch
{
 ...
 public static class GlobalVariables
 {
  ...
  public static void InitialiseSecret()
  {
   ...
   my_data.Add("job_title", "ProductAnalyst");
   my_data.Add("job_description", "Analyse data");
   my_data.Add("job_note", "a/b tests");
   my_data.Add("job_title_new", "DataAnalyst");
  }
 ...
 public class Driver : ChromeDriver
 {
  ...
  public string IsChangesVisible(string job_title_)  
  {
   ...
   try
   {
    this.FindElement(By.XPath($"//table[@id='resultTable']/tbody/tr/td[@class='left']/a[text()='{job_title_}']")).Click();
    answer = "SUCCESS";
   }
   catch (NoSuchElementException)
   {
 ...
 class MainClass
 {
  ...
  [Test]
  public void Test2_2_AddInfo_Check()
  {
  ...
  [Test]
  public void Test3_1_ChangeInfo()
  {
  ...
  [Test]
  public void Test3_2_ChangeInfo_Check()
  {
